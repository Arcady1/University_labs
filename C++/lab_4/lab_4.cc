...
class Letters
{
    ...
    public:
        ...
        Letters(char*);                                         // конструктор инициализации строки и преобразования слова в бинарный код; принимает введенное слово
        int operator,(Letters&);                                // перегрузка оператора ',' для перемножения слова и алфавита заглавных букв; принимает введенное слово, возвращает число заглавных букв в слове

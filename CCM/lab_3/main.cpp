/*
В заданной [0,1] – матрице М, размеров 6х6, требуется выбрать по одной 1 последовательно
из каждой ее строки сверху вниз, которые должны иметь попарно различные индексы своих
столбцов.

Компиляция: g++ lab3_9.cc 
Запуск: ./a.out
*/
